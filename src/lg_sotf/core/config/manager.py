...
class AgentConfig(BaseSettings):
    ...
    ingestion_polling_interval: int = Field(default=60, env="INGESTION_POLLING_INTERVAL")
    triage_confidence_threshold: int = Field(default=70, env="TRIAGE_CONFIDENCE_THRESHOLD")
    analysis_max_iterations: int = Field(default=5, env="ANALYSIS_MAX_ITERATIONS")
    human_escalation_threshold: int = Field(default=40, env="HUMAN_ESCALATION_THRESHOLD")
